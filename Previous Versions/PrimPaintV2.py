...
class Paint(object):
    ...
    def __init__(self):
        ...
        # display file button
        btn_open_file = Button(self.root,
                            text="Open File",
        ...
        btn_open_file.place(x=65,y=0)

        # exit button
        btn_exit = Button(self.root,
                        text="Exit",
                        command=exit)
        btn_exit.place(x=125,y=0)
    ...
    # save file method
    # currently non-functioning, just a copy paste of the open file method
    def saveFile(self):
        filename = filedialog.askopenfilename(initialdir="/",
                                            title="Select a File",
                                            filetypes=(("png files", "*.png"),
